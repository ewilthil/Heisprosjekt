...
/*TEMPORARY_STOP*/	{{EXECUTING_ORDER, ctrl_doorClosed, ctrl_handleDestination},	{IDLE, NULL, NULL},					{EMERGENCY_STOP, NULL, ctrl_handleEmergencyStop}	},
/*IDLE*/		{{EXECUTING_ORDER, NULL, ctrl_handleDestination}, 		{IDLE, NULL, NULL},					{EMERGENCY_STOP, NULL, ctrl_handleEmergencyStop}	},
/*EMERGENCY_STOP*/	{{EXECUTING_ORDER, ctrl_noObstruction, ctrl_handleDestination}, {EMERGENCY_STOP, NULL, NULL},				{EMERGENCY_STOP, NULL, ctrl_handleEmergencyStop}	}
};
