...
/*EMERGENCY_STOP*/	{{EXECUTING_ORDER, ctrl_noObstruction, ctrl_handleDestinationFromEM},	{EMERGENCY_STOP, NULL, NULL},				{EMERGENCY_STOP, NULL, ctrl_handleEmergencyStop},	{EMERGENCY_STOP, ctrl_orderTypeCommand, ctrl_addOrderToList}	}
};
